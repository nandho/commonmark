...
<body>
                ...
                <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                    <div class="flex items-center space-x-3 rtl:space-x-reverse">
                        ...
                        <div id="hideOnSmallScreen">
                            ...
                            <br>
                            <span
                                class="text-base md:text-lg font-semibold whitespace-nowrap light:text-white">Yogyakarta</span>
                        </div>
                    </div>
                    ...
                    <div class="w-full md:block md:w-auto hidden" id="navbar-default">
                        <ul
                            class="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-white light:bg-gray-800 md:light:bg-gray-900 light:border-gray-700">
                            <li>
                                <a href="#"
                                    class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 light:text-white md:light:hover:text-blue-500 light:hover:bg-gray-700 light:hover:text-white md:light:hover:bg-transparent">About</a>
                            </li>
                            <li>
                                <a href="#"
                                    class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 light:text-white md:light:hover:text-blue-500 light:hover:bg-gray-700 light:hover:text-white md:light:hover:bg-transparent">Services</a>
                            </li>
                            <li>
                                <a href="#"
                                    class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 light:text-white md:light:hover:text-blue-500 light:hover:bg-gray-700 light:hover:text-white md:light:hover:bg-transparent">Pricing</a>
                            </li>
                            <li>
                                <a href="#"
                                    class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 light:text-white md:light:hover:text-blue-500 light:hover:bg-gray-700 light:hover:text-white md:light:hover:bg-transparent">Contact</a>
                            </li>
                            <li>
                                <a href="/login"
                                    class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 light:text-white md:light:hover:text-blue-500 light:hover:bg-gray-700 light:hover:text-white md:light:hover:bg-transparent">Login</a>
                            </li>
                        </ul>
                    </div>
                    <div id="navdesktop" class="hidden md:block md:w-auto">
                        <!-- Tambahkan class 'hidden' untuk menyembunyikan menu desktop pada tampilan mobile -->
                        <ul
                            class="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-white light:bg-gray-800 md:light:bg-gray-900 light:border-gray-700">
                            <li>
                                <a href="#"
                ...
                <div class="container px-6 mx-auto grid">
                    <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md light:bg-gray-800">
                        <div class="container mx-auto px-4 md:px-6">
                            <div
                                class="flex items-center justify-between p-4 mb-8 font-semibold text-purple-100 bg-purple-600 rounded-lg shadow-md focus:outline-none focus:shadow-outline-purple">
                        ...
                        <div class="container mx-auto px-4 md:px-6" x-data="{ schoolName: '', schools: [], NamaL: [], NIK: [], NISN: [], jk: [], HP: [], email: [], selectedSchool: '', selectedProvince: '', selectedCity: '', provinces: [], cities: [], selectedType: '', programstudi: '', jurusanItems: [], jurusanasal: [], lulus: [], NamaW: [], NIKW: [], NOHPW: [] }">
                            ...
                            <form class="mb-4" id="schoolForm">
                                <div class="container mx-auto px-4 md:px-6">
                                    <div class="p-4 mb-4 text-sm text-blue-800 rounded-lg bg-blue-50 light:bg-gray-800 light:text-blue-400"
                                        role="alert">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div x-model="NamaL" class="container mx-auto px-4 md:px-6">
                                        <label for="NamaL" class="block text-sm font-medium text-gray-700 mb-2">Nama
                                            Lengkap: <span class="text-red-500">*</span></label>
                                        <input type="text" x-model="NamaL" id="NamaL" name="NamaL"
                                            class="border border-gray-300 rounded-md px-4 py-2 w-full"
                                            placeholder="Isikan Nama Lengkap Anda">

                                    </div>
                                    <div x-model="NIK" class="container mx-auto px-4 md:px-6">
                                        <label for="NIK" class="block text-sm font-medium text-gray-700 mb-2">NIK:
                                            <span class="text-red-500">*</span></label>
                                        <input type="nomor" x-model="NIK" id="NIK" name="NIK"
                                            class="border border-gray-300 rounded-md px-4 py-2 w-full"
                                    ...
                                    <div x-model="NISN" class="container mx-auto px-4 md:px-6">
                                        <label for="NISN"
                                            class="block text-sm font-medium text-gray-700 mb-2">NISN: <span
                                                class="text-red-500">*</span></label>
                                        <input type="nomor" x-model="NISN" id="NISN" name="NISN"
                                            class="border border-gray-300 rounded-md px-4 py-2 w-full"
                                            placeholder="Isikan NISN Anda">
                                    ...
                                    <div class="container mx-auto px-4 md:px-6">
                                        ...
                                        <div x-model="jk" id="jk" name="jk" class="mt-2">
                                            ...
                                            <label
                                                class="inline-flex items-center ml-6 text-gray-900 light:text-white">
                                                <input type="radio"
                                                    class="text-purple-600 form-radio focus:border-purple-400 focus:outline-none focus:shadow-outline-purple light:focus:shadow-outline-gray"
                                    ...
                                    <div x-model="HP" class="container mx-auto px-4 md:px-6">
                                        <label for="HP" class="block text-sm font-medium text-gray-700 mb-2">No.
                                            HP: <span class="text-red-500">*</span></label>
                                        <input type="nomor" x-model="HP" id="HP" name="HP"
                                            class="border border-gray-300 rounded-md px-4 py-2 w-full"
                                            placeholder="082xxxxxxxxx">
                                    </div>
                                    <div x-model="email" class="container mx-auto px-4 md:px-6">
                                        <label for="email"
                                            class="block text-sm font-medium text-gray-700 mb-2">E-mail: <span
                                                class="text-red-500">*</span></label>
                                        <input type="email" x-model="email" id="email" name="email"
                                            class="border border-gray-300 rounded-md px-4 py-2 w-full"
                                            placeholder="example@domaian.com">
                                    </div>
                                    ...
                                    <div class="container mx-auto px-4 md:px-6">
                                        <label for="selectedProvince"
                                            class="block text-sm font-medium text-gray-700">Provinsi: <span
                                                class="text-red-500">*</span></label>
                                        <select x-model="selectedProvince" id="selectedProvince"
                                    ...
                                    <div class="container mx-auto px-4 md:px-6">
                                        <label for="selectedCity"
                                            class="block text-sm font-medium text-gray-700">Kabupaten/Kota: <span
                                                class="text-red-500">*</span></label>
                                        <select x-model="selectedCity" id="selectedCity" name="selectedCity"
                                            class="border border-gray-300 rounded-md px-4 py-2 w-full">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div class="container mx-auto px-4 md:px-6">
                                        <label for="schoolName" class="block text-sm font-medium text-gray-700">Nama
                                            Sekolah: <span class="text-red-500">*</span></label>
                                        <input type="text" x-model="schoolName" id="schoolName" name="schoolName"
                                            required class="border border-gray-300 rounded-md px-4 py-2 w-full"
                                            placeholder="Masukan Nama Sekolah Dengan Lengkap">
                                        ...
                                        <div x-show="schools.length === 0 && schoolName !== ''" class="mb-4">
                                            <label for="manualInput"
                                                class="block text-sm font-medium text-gray-700 mb-2">Masukkan Nama
                                                Sekolah:</label>
                                            <input type="text" x-model="selectedSchool" id="manualInput"
                                                name="manualInput"
                                                class="border border-gray-300 rounded-md px-4 py-2 w-full">
                                        </div>
                                        ...
                                        <div class="mb-4" x-show="schools.length > 0">
                                            <label for="selectedSchool"
                                                class="block text-sm font-medium text-gray-700 mb-2">Pilih Sekolah:
                                                <span class="text-red-500">*</span></label>
                                            <select x-model="selectedSchool" id="selectedSchool"
                                                name="selectedSchool"
                                                class="border border-gray-300 rounded-md px-4 py-2 w-full">
                                                <option value="" disabled selected>Pilih Sekolah</option>
                                                <template x-for="school in schools" :key="school.npsn">
                                                    <option x-text="`${school.npsn} - ${school.sekolah}`"
                                                        :value="`${school.npsn}:${school.sekolah}`"></option>
                                                </template>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="container mx-auto px-4 md:px-6">
                                        <label for="schoolType"
                                            class="block text-sm font-medium text-gray-700 mb-2">Jenis Sekolah: <span
                                                class="text-red-500">*</span></label>
                                        <select x-model="selectedType" id="selectedType" name="schoolType"
                                            class="border border-gray-300 rounded-md px-4 py-2 w-full">
                                    ...
                                    <div x-model="jurusanasal" class="container mx-auto px-4 md:px-6">
                                        <label for="jurusanasal"
                                            class="block text-sm font-medium text-gray-700 mb-2">Jurusan Sekolah (Cth:
                                            IPA, IPS): <span class="text-red-500">*</span></label>
                                        <input type="text" x-model="jurusanasal" id="jurusanasal"
                                            name="jurusanasal"
                                            class="border border-gray-300 rounded-md px-4 py-2 w-full"
                                            placeholder="Isi Jurusan Anda">
                                    </div>
                                    <div x-model="lulus" class="container mx-auto px-4 md:px-6">
                                        <label for="lulus"
                                            class="block text-sm font-medium text-gray-700 mb-2">Tahun Lulus (Cth:
                                            2023): <span class="text-red-500">*</span></label>
                                        <input type="text" x-model="lulus" id="lulus" name="lulus"
                                            class="border border-gray-300 rounded-md px-4 py-2 w-full"
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div class="container mx-auto px-4 md:px-6">
                                        <label for="jurusan"
                                            class="block text-sm font-medium text-gray-700 mb-2">Progam Studi: <span
                                                class="text-red-500">*</span></label>
                                    ...
                                    <div x-model="NamaW" class="container mx-auto px-4 md:px-6">
                                        <label for="NamaW"
                                            class="block text-sm font-medium text-gray-700 mb-2">Nama Orang Tua/ Wali:
                                            <span class="text-red-500">*</span></label>
                                        <input type="text" x-model="NamaW" id="NamaW" name="NamaW"
                                            class="border border-gray-300 rounded-md px-4 py-2 w-full"
                                            placeholder="Isi Jurusan Anda">
                                    </div>
                                    <div x-model="NOHPW" class="container mx-auto px-4 md:px-6">
                                        <label for="NOHPW" class="block text-sm font-medium text-gray-700 mb-2">No.
                                            HP Orang Tua / Wali: <span class="text-red-500">*</span></label>
                                        <input type="nomor" x-model="NOHPW" id="NOHPW" name="NOHPW"
                                            class="border border-gray-300 rounded-md px-4 py-2 w-full"
                                            placeholder="082xxxxxxxxx">

                                    </div>
                                    <div x-model="NIKW" class="container mx-auto px-4 md:px-6">
                                        <label for="NIKW" class="block text-sm font-medium text-gray-700 mb-2">NIK
                                            Orang Tua / Wali: <span class="text-red-500">*</span></label>
                                        <input type="nomor" x-model="NIKW" id="NIKW" name="NIKW"
                                            class="border border-gray-300 rounded-md px-4 py-2 w-full"
                                            placeholder="Isi NIK Orang Tua/Wali">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 justify-end">
                                    <div class="container mx-auto px-4 md:px-6">
                                        <button type="submit"
                                            class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center light:bg-blue-600 light:hover:bg-blue-700 light:focus:ring-blue-800">Kirim
                                            Data</button>
                                    </div>
                                </div>
                            </form>
    ...
    <script>
        ...
        async function fetchData(schoolName) {
            const apiUrl = 'https://api-sekolah-indonesia.vercel.app/sekolah/s?sekolah=' + encodeURIComponent(
                schoolName);
        ...
        document.getElementById('schoolForm').addEventListener('submit', function(event) {
            ...
            const provinsi = document.getElementById('selectedProvince').options[document.getElementById(
                'selectedProvince').selectedIndex].text;
            const selectedCityName = document.getElementById('selectedCity').value;
            const kabupaten = document.getElementById('selectedCity').options[document.getElementById(
                'selectedCity').selectedIndex].text;
