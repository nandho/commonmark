                ...
                <div class="container px-6 mx-auto grid">
                    <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md light:bg-gray-800">
                        ...
                        <form>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div class="container mx-auto px-4 md:px-6">
                                    <label for="negara" class="block mb-2 text-sm font-medium text-gray-900 light:text-white">Provinsi
                                        <span class="text-red-500">*</span>
                                    </label>
                                    <div x-data="select({ data: { ht: 'HTML', css: 'CSS', php: 'PHP', java: 'JavaScript', py: 'Python', lara: 'Laravel' }, emptyOptionsMessage: 'No Course Match Your Search.', name: 'course', placeholder: 'Pilih Provinsi' })" x-init="init()" @click.away="closeListbox()" @keydown.escape="closeListbox()" class="relative">
                                        <span class="inline-block w-full rounded-md shadow-sm">
                                            <button x-ref="button" @click="toggleListboxVisibility($event)" :aria-expanded="open" aria-haspopup="listbox" class="relative z-0 w-full py-2 pl-3 pr-10 text-left transition duration-150 ease-in-out bg-gray-50 border border-gray-300 text-gray-900 rounded-md cursor-default focus:outline-none focus:shadow-outline-blue focus:border-blue-300 sm:text-sm sm:leading-5">
                                                <span x-show="!open" x-text="value in options ? options[value] : placeholder" :class="{ 'text-gray-500': !(value in options) }" class="block truncate"></span>
                                            </button>
                                ...
                                <div class="container mx-auto px-4 md:px-6">
                                    ...
                                    <div x-data="select({ data: { ht: 'HTML', css: 'CSS', php: 'PHP', java: 'JavaScript', py: 'Python', lara: 'Laravel' }, emptyOptionsMessage: 'No Course Match Your Search.', name: 'course', placeholder: 'Pilih Kabupaten / Kota' })" x-init="init()" @click.away="closeListbox()" @keydown.escape="closeListbox()" class="relative">
                                        <span class="inline-block w-full rounded-md shadow-sm">
                                            <button x-ref="button" @click="toggleListboxVisibility($event)" :aria-expanded="open" aria-haspopup="listbox" class="relative z-0 w-full py-2 pl-3 pr-10 text-left transition duration-150 ease-in-out bg-gray-50 border border-gray-300 text-gray-900 rounded-md cursor-default focus:outline-none focus:shadow-outline-blue focus:border-blue-300 sm:text-sm sm:leading-5">
                                                <span x-show="!open" x-text="value in options ? options[value] : placeholder" :class="{ 'text-gray-500': !(value in options) }" class="block truncate"></span>
                                            </button>
                                ...
                                <div class="container mx-auto px-4 md:px-6">
                                    <label for="negara" class="block mb-2 text-sm font-medium text-gray-900 light:text-white">Jenis Sekolah
                                        <span class="text-red-500">*</span>
                                    </label>
                                    <div x-data="select({ data: { ht: 'HTML', css: 'CSS', php: 'PHP', java: 'JavaScript', py: 'Python', lara: 'Laravel' }, emptyOptionsMessage: 'No Course Match Your Search.', name: 'course', placeholder: 'Pilih Jenis Sekolah' })" x-init="init()" @click.away="closeListbox()" @keydown.escape="closeListbox()" class="relative">
                                        <span class="inline-block w-full rounded-md shadow-sm">
                                            <button x-ref="button" @click="toggleListboxVisibility($event)" :aria-expanded="open" aria-haspopup="listbox" class="relative z-0 w-full py-2 pl-3 pr-10 text-left transition duration-150 ease-in-out bg-gray-50 border border-gray-300 text-gray-900 rounded-md cursor-default focus:outline-none focus:shadow-outline-blue focus:border-blue-300 sm:text-sm sm:leading-5">
                                                <span x-show="!open" x-text="value in options ? options[value] : placeholder" :class="{ 'text-gray-500': !(value in options) }" class="block truncate"></span>
                                            </button>
                                ...
                                <div class="container mx-auto px-4 md:px-6" x-data="{ showSchoolInput: false }">
                                    <label for="negara" class="block mb-2 text-sm font-medium text-gray-900 light:text-white">NPSN / Nama Sekolah
                                        <span class="text-red-500">*</span>
                                    </label>
                                    <div x-data="select({ data: { ht: 'HTML', css: 'CSS', php: 'PHP', java: 'JavaScript', py: 'Python', lara: 'Laravel' }, emptyOptionsMessage: 'No Course Match Your Search.', name: 'course', placeholder: 'Pilih NPSN / Nama Sekolah', showSchoolInput: showSchoolInput })" x-init="init()" @click.away="closeListbox()" @keydown.escape="closeListbox()" class="relative">
                                        <span class="inline-block w-full rounded-md shadow-sm">
                                            <button x-ref="button" @click="toggleListboxVisibility($event)" :aria-expanded="open" aria-haspopup="listbox" class="relative z-0 w-full py-2 pl-3 pr-10 text-left transition duration-150 ease-in-out bg-gray-50 border border-gray-300 text-gray-900 rounded-md cursor-default focus:outline-none focus:shadow-outline-blue focus:border-blue-300 sm:text-sm sm:leading-5">
                                                <span x-show="!open" x-text="value in options ? options[value] : placeholder" :class="{ 'text-gray-500': !(value in options) }" class="block truncate"></span>
                                            </button>
                                ...
                                <div class="container mx-auto px-4 md:px-6">
                                    <label for="negara" class="block mb-2 text-sm font-medium text-gray-900 light:text-white">Jurusan Sekolah (Cth: IPA, IPS)
                                        <span class="text-red-500">*</span>
                                    </label>
                                    <div x-data="select({ data: { ht: 'HTML', css: 'CSS', php: 'PHP', java: 'JavaScript', py: 'Python', lara: 'Laravel' }, emptyOptionsMessage: 'No Course Match Your Search.', name: 'course', placeholder: 'Pilih Jurusan Sekolah ' })" x-init="init()" @click.away="closeListbox()" @keydown.escape="closeListbox()" class="relative">
                                        <span class="inline-block w-full rounded-md shadow-sm">
                                            <button x-ref="button" @click="toggleListboxVisibility($event)" :aria-expanded="open" aria-haspopup="listbox" class="relative z-0 w-full py-2 pl-3 pr-10 text-left transition duration-150 ease-in-out bg-gray-50 border border-gray-300 text-gray-900 rounded-md cursor-default focus:outline-none focus:shadow-outline-blue focus:border-blue-300 sm:text-sm sm:leading-5">
                                                <span x-show="!open" x-text="value in options ? options[value] : placeholder" :class="{ 'text-gray-500': !(value in options) }" class="block truncate"></span>
                                            </button>
                                ...
                                <div class="container mx-auto px-4 md:px-6">
                                    <label for="negara" class="block mb-2 text-sm font-medium text-gray-900 light:text-white">Tahun Lulus
                                        <span class="text-red-500">*</span>
                                    </label>
                                    <div x-data="select({ data: { ht: 'HTML', css: 'CSS', php: 'PHP', java: 'JavaScript', py: 'Python', lara: 'Laravel' }, emptyOptionsMessage: 'No Course Match Your Search.', name: 'course', placeholder: 'Pilih Tahun Lulus' })" x-init="init()" @click.away="closeListbox()" @keydown.escape="closeListbox()" class="relative">
                                        <span class="inline-block w-full rounded-md shadow-sm">
                                            <button x-ref="button" @click="toggleListboxVisibility($event)" :aria-expanded="open" aria-haspopup="listbox" class="relative z-0 w-full py-2 pl-3 pr-10 text-left transition duration-150 ease-in-out bg-gray-50 border border-gray-300 text-gray-900 rounded-md cursor-default focus:outline-none focus:shadow-outline-blue focus:border-blue-300 sm:text-sm sm:leading-5">
                                                <span x-show="!open" x-text="value in options ? options[value] : placeholder" :class="{ 'text-gray-500': !(value in options) }" class="block truncate"></span>
                                            </button>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div class="container mx-auto px-4 md:px-6">
                                    <label for="negara" class="block mb-2 text-sm font-medium text-gray-900 light:text-white">Program Studi
                                        <span class="text-red-500">*</span>
                                    </label>
                                    <div x-data="select({ data: { ht: 'HTML', css: 'CSS', php: 'PHP', java: 'JavaScript', py: 'Python', lara: 'Laravel' }, emptyOptionsMessage: 'No Course Match Your Search.', name: 'course', placeholder: 'Pilih Program Studi' })" x-init="init()" @click.away="closeListbox()" @keydown.escape="closeListbox()" class="relative">
                                        <span class="inline-block w-full rounded-md shadow-sm">
                                            <button x-ref="button" @click="toggleListboxVisibility($event)" :aria-expanded="open" aria-haspopup="listbox" class="relative z-0 w-full py-2 pl-3 pr-10 text-left transition duration-150 ease-in-out bg-gray-50 border border-gray-300 text-gray-900 rounded-md cursor-default focus:outline-none focus:shadow-outline-blue focus:border-blue-300 sm:text-sm sm:leading-5">
                                                <span x-show="!open" x-text="value in options ? options[value] : placeholder" :class="{ 'text-gray-500': !(value in options) }" class="block truncate"></span>
                                            </button>
