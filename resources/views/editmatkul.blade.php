                ...
                <div class="flex-auto p-6">
                    ...
                    <form id="mkForm" enctype="multipart/form-data">
                        ...
                        <div class="flex flex-wrap -mx-3">
                            ...
                            <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                <div class="mb-4">
                                    <label for="kode_matkul" class="inline-block mb-2 ml-1 font-bold text-xs text-slate-700 dark:text-white/80">Kode
                                        Matakuliah</label>
                            ...
                            <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                <div class="mb-4">
                                    <label for="sifat_matkul" class="inline-block mb-2 ml-1 font-bold text-xs text-slate-700 dark:text-white/80">Sifat
                                        Matakuliah</label>
                            ...
                            <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                <div class="mb-4">
                                    <label for="tipe_matkul" class="inline-block mb-2 ml-1 font-bold text-xs text-slate-700 dark:text-white/80">Tipe
                                        Matakuliah</label>
                            ...
                            <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                <div class="mb-4">
                                    <label for="kategori_matkul" class="inline-block mb-2 ml-1 font-bold text-xs text-slate-700 dark:text-white/80">Kategori
                                        Matakuliah</label>
                            ...
                            <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                <div class="mb-4">
                                    <label for="jenis_kurikulum" class="inline-block mb-2 ml-1 font-bold text-xs text-slate-700 dark:text-white/80">Jenis
                                        Kurikulum</label>
                            ...
                            <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                <div class="mb-4">
                                    <label for="paket_semester" class="inline-block mb-2 ml-1 font-bold text-xs text-slate-700 dark:text-white/80">Jenis
                            ...
                            <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                <div class="mb-4">
                                    <label for="batas_ambil_ulang" class="inline-block mb-2 ml-1 font-bold text-xs text-slate-700 dark:text-white/80">Batas
                            ...
                            <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                <div class="mb-4">
                                    <label for="status_matkul" class="inline-block mb-2 ml-1 font-bold text-xs text-slate-700 dark:text-white/80">Status
                                        Matakuliah</label>
                            ...
                            <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                <div class="mb-4">
                                    <label for="satuan_acara_perkulihan" class="inline-block mb-2 ml-1 font-bold text-xs text-slate-700 dark:text-white/80">Satuan
                            ...
                            <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                <div class="mb-4">
                                    <label for="bahan_ajar" class="inline-block mb-2 ml-1 font-bold text-xs text-slate-700 dark:text-white/80">Bahan
                                        Ajar</label>
                            ...
                            <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                <div class="mb-4">
                                    <label for="dosen_nama" class="inline-block mb-2 ml-1 font-bold text-xs text-slate-700 dark:text-white/80">Dosen
                                        Pengampu</label>
                                    <div class="flex">
                            ...
                            <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                <div class="mb-4">
                                    <label for="tanggal_mulai_efektif" class="inline-block mb-2 ml-1 font-bold text-xs text-slate-700 dark:text-white/80">Tanggal
                                        Mulai Efektif</label>
                            ...
                            <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                <div class="mb-4">
                                    <label for="diktat" class="inline-block mb-2 ml-1 font-bold text-xs text-slate-700 dark:text-white/80">Tanggal
                                        Akhir Efektif</label>
                            ...
                            <div class="w-full max-w-full px-3 shrink-0">
                                ...
                                <div class="flex flex-wrap -mx-3">
                                    ...
                                    <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                        <div class="mb-4">
                                            <label for="nama_matkul_singkat" class="inline-block mb-2 ml-1 font-bold text-xs text-slate-700 dark:text-white/80">Singkat
                                                Indonesia</label>
                                    ...
                                    <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                        <div class="mb-4">
                                            <label for="nama_matkul_singkat_english" class="inline-block mb-2 ml-1 font-bold text-xs text-slate-700 dark:text-white/80">Singkat
                                                Inggris</label>
                            ...
                            <div class="w-full max-w-full px-3 shrink-0">
                                ...
                                <div class="flex flex-wrap -mx-3">
                                    <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                        <div class="mb-4">
                                            <label for="sks_kurikulum" class="inline-block mb-2 ml-1 font-bold text-xs text-slate-700 dark:text-white/80">SKS
                                                Kurikulum</label>
                                    ...
                                    <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                        <div class="mb-4">
                                            <label for="praklap_sks" class="inline-block mb-2 ml-1 font-bold text-xs text-slate-700 dark:text-white/80">Praktikum
                                                Lapangan</label>
                            ...
                            <div class="w-full max-w-full px-3 shrink-0">
                                ...
                                <div class="flex flex-wrap -mx-3">
                                    <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                        <div class="mb-4">
                                            <label for="bobot_nilai_minimal" class="inline-block mb-2 ml-1 font-bold text-xs text-slate-700 dark:text-white/80">Bobot
                                    ...
                                    <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                        <div class="mb-4">
                                            <label for="ipk_minimal" class="inline-block mb-2 ml-1 font-bold text-xs text-slate-700 dark:text-white/80">Syarat
                                                IPK Minimal</label>
                                ...
                                <div class="w-full max-w-full px-3 shrink-0">
                                    ...
                                    <div class="flex flex-wrap -mx-3">
                                        <div class="w-full max-w-full px-3 shrink-0 md:w-4/12 md:flex-0">
                                            <div class="mb-4">
                                                <label for="matkul_wajib" class="inline-block mb-2 ml-1 font-bold text-xs text-slate-700 dark:text-white/80">Matakuliah
                                                    Wajib</label>
                                                <div class="flex items-center">
                                        ...
                                        <div class="w-full max-w-full px-3 shrink-0 md:w-4/12 md:flex-0">
                                            <div class="mb-4">
                                                <label for="matkul_pilihan" class="inline-block mb-2 ml-1 font-bold text-xs text-slate-700 dark:text-white/80">Matakuliah
                                                    Pilihan</label>
                                                <div class="flex items-center">
                                        ...
                                        <div class="w-full max-w-full px-3 shrink-0 md:w-4/12 md:flex-0">
                                            <div class="mb-4">
                                                <label for="total_matkul" class="inline-block mb-2 ml-1 font-bold text-xs text-slate-700 dark:text-white/80">Total
                                                    Matakuliah</label>
                                                <div class="flex items-center">
                                ...
                                <div class="w-full max-w-full px-3 shrink-0">
                                    ...
                                    <div class="flex flex-wrap -mx-3">
                                        <div class="w-full max-w-full px-3 shrink-0 md:w-4/12 md:flex-0">
                                            <div class="mb-4">
                                                <label for="sks_matkul_wajib" class="inline-block mb-2 ml-1 font-bold text-xs text-slate-700 dark:text-white/80">SKS
                                        ...
                                        <div class="w-full max-w-full px-3 shrink-0 md:w-4/12 md:flex-0">
                                            <div class="mb-4">
                                                <label for="sks_matkul_pilihan" class="inline-block mb-2 ml-1 font-bold text-xs text-slate-700 dark:text-white/80">SKS
                                        ...
                                        <div class="w-full max-w-full px-3 shrink-0 md:w-4/12 md:flex-0">
                                            <div class="mb-4">
                                                <label for="total_sks_matkul" class="inline-block mb-2 ml-1 font-bold text-xs text-slate-700 dark:text-white/80">Total
