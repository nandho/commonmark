            ...
            <div class="w-full max-w-full px-3 shrink-0  md:flex-0">
                <div
                    ...
                    <div class="flex-auto p-6">
                        ...
                        <div id="dosen_modal"
                            class="w-8/12 fixed inset-0 items-center justify-center p-4 bg-opacity-50 hidden">
                            <div class="w-4/5 bg-white dark:bg-slate-850 shadow-xl rounded-lg p-6 mx-auto">
                                ...
                                <button type="button" id="close_modal_btn"
                                    class="mt-4 bg-blue-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded">Tutup</button>
                            </div>
                        </div>
                        <form id="mkForm" enctype="multipart/form-data">
                            <button type="submit" id="simpanMKBtn"
                            ...
                            <div class="flex flex-wrap -mx-3">
                                <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                    <div class="mb-4">
                                        <label for="jurusan"
                                            class="inline-block mb-2 ml-1 font-bold text-xs text-slate-700 dark:text-white/80">Semester</label>
                                ...
                                <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                    <div class="mb-4">
                                        <label for="nama_kurikulum"
                                            class="inline-block mb-2 ml-1 font-bold text-xs text-slate-700 dark:text-white/80">Kurikulum</label>
                                        <select id="nama_kurikulum" name="nama_kurikulum"
                                            class="focus:shadow-primary-outline dark:bg-slate-850 dark:text-white text-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none">
                                ...
                                <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                    <div class="mb-4">
                                        <label for="tipe_matkul"
                                            class="inline-block mb-2 ml-1 font-bold text-xs text-slate-700 dark:text-white/80">Tipe
                                            Matakuliah</label>
                                        <select id="tipe_matkul" name="tipe_matkul"
                                            class="focus:shadow-primary-outline dark:bg-slate-850 dark:text-white text-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none">
                                ...
                                <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                    <div class="mb-4">
                                        <label for="jenis_kurikulum"
                                            class="inline-block mb-2 ml-1 font-bold text-xs text-slate-700 dark:text-white/80">Jenis
                                            Kurikulum</label>
                                        <select id="jenis_kurikulum" name="jenis_kurikulum"
                                            class="focus:shadow-primary-outline dark:bg-slate-850 dark:text-white text-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none">
                                ...
                                <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                    <div class="mb-4">
                                        <label for="paket_semester"
                                            class="inline-block mb-2 ml-1 font-bold text-xs text-slate-700 dark:text-white/80">Jenis
                                            Paket Semester</label>
                                        <select id="paket_semester" name="paket_semester"
                                            class="focus:shadow-primary-outline dark:bg-slate-850 dark:text-white text-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none">
                                ...
                                <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                    <div class="mb-4">
                                        <label for="batas_ambil_ulang"
                                            class="inline-block mb-2 ml-1 font-bold text-xs text-slate-700 dark:text-white/80">Batas
                                            Maksimal Pengambilan Ulang</label>
                                        <input type="text" id="batas_ambil_ulang" name="batas_ambil_ulang"
                                            class="focus:shadow-primary-outline dark:bg-slate-850 dark:text-white text-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none" />
                                    </div>
                                </div>
                                <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                    <div class="mb-4">
                                        <label for="status_matkul"
                                            class="inline-block mb-2 ml-1 font-bold text-xs text-slate-700 dark:text-white/80">Status
                                            Matakuliah</label>
                                        <select id="status_matkul" name="status_matkul"
                                            class="focus:shadow-primary-outline dark:bg-slate-850 dark:text-white text-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none">
                                ...
                                <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                    <div class="mb-4">
                                        <label for="bahan_ajar"
                                            class="inline-block mb-2 ml-1 font-bold text-xs text-slate-700 dark:text-white/80">Bahan
                                            Ajar</label>
                                        <input type="text" id="bahan_ajar" name="bahan_ajar"
                                            class="focus:shadow-primary-outline dark:bg-slate-850 dark:text-white text-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none" />
                                    </div>
                                </div>
                                <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                    <div class="mb-4">
                                        <label for="diktat"
                                            class="inline-block mb-2 ml-1 font-bold text-xs text-slate-700 dark:text-white/80">Diktat</label>
                                        <input type="text" id="diktat" name="diktat"
                                            class="focus:shadow-primary-outline dark:bg-slate-850 dark:text-white text-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none" />
                                    </div>
                                </div>
                                ...
                                <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                    <div class="mb-4">
                                        <label for="dosen_nama"
                                            class="inline-block mb-2 ml-1 font-bold text-xs text-slate-700 dark:text-white/80">Dosen
                                            Pengampu</label>
                                        <div class="flex">
                                            <input type="text" id="dosen_nama" name="dosen_nama"
                                            ...
                                            <!-- Input untuk menyimpan ID dosen -->
                                            <button type="button" id="pilih_dosen_btn"
                                                class="ml-2 px-4 py-2 bg-blue-500 text-white rounded-lg">Pilih</button>
                                        </div>
                                    </div>
                                </div>
                                <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                    <div class="mb-4">
                                        <label for="tanggal_mulai_efektif"
                                ...
                                <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                    <div class="mb-4">
                                        <label for="diktat"
                                            class="inline-block mb-2 ml-1 font-bold text-xs text-slate-700 dark:text-white/80">Tanggal
                                            Akhir Efektif</label>
                                        <input type="date" id="tanggal_selesai_efektif" name="tanggal_selesai_efektif"
                                            class="focus:shadow-primary-outline dark:bg-slate-850 dark:text-white text-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none" />
                                    </div>
                                </div>
                                ...
                                <div class="w-full max-w-full px-3 shrink-0">
                                    ...
                                    <div class="flex flex-wrap -mx-3">
                                        <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                            <div class="mb-4">
                                                <label for="nama_matkul_indonesia"
                                                    class="inline-block mb-2 ml-1 font-bold text-xs text-slate-700 dark:text-white/80">Indonesia</label>
                                        ...
                                        <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                            <div class="mb-4">
                                                <label for="nama_matkul_singkat"
                                                    class="inline-block mb-2 ml-1 font-bold text-xs text-slate-700 dark:text-white/80">Singkat
                                                    Indonesia</label>
                                                <input type="text" id="nama_matkul_singkat" name="nama_matkul_singkat"
                                                    class="focus:shadow-primary-outline dark:bg-slate-850 dark:text-white text-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none" />
                                            </div>
                                        </div>
                                        <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                            <div class="mb-4">
                                                <label for="nama_matkul_english"
                                                    class="inline-block mb-2 ml-1 font-bold text-xs text-slate-700 dark:text-white/80">Inggris</label>
                                                <input type="text" id="nama_matkul_english" name="nama_matkul_english"
                                                    class="focus:shadow-primary-outline dark:bg-slate-850 dark:text-white text-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none" />
                                            </div>
                                        </div>
                                        <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                            <div class="mb-4">
                                                <label for="nama_matkul_singkat_english"
                                                    class="inline-block mb-2 ml-1 font-bold text-xs text-slate-700 dark:text-white/80">Singkat
                                                    Inggris</label>
                                                <input type="text" id="nama_matkul_singkat_english"
                                                    name="nama_matkul_singkat_english"
                                                    class="focus:shadow-primary-outline dark:bg-slate-850 dark:text-white text-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none" />
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="w-full max-w-full px-3 shrink-0">
                                    ...
                                    <div class="flex flex-wrap -mx-3">
                                        <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                            <div class="mb-4">
                                                <label for="sks_kurikulum"
                                                    class="inline-block mb-2 ml-1 font-bold text-xs text-slate-700 dark:text-white/80">SKS
                                                    Kurikulum</label>
                                                <input type="text" id="sks_kurikulum" name="sks_kurikulum"
                                                    class="focus:shadow-primary-outline dark:bg-slate-850 dark:text-white text-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none" />
                                            </div>
                                        </div>
                                        <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                            <div class="mb-4">
                                                <label for="teori_sks"
                                                    class="inline-block mb-2 ml-1 font-bold text-xs text-slate-700 dark:text-white/80">Teori</label>
                                                <input type="text" id="teori_sks" name="teori_sks"
                                                    class="focus:shadow-primary-outline dark:bg-slate-850 dark:text-white text-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none" />
                                            </div>
                                        </div>
                                        <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                            <div class="mb-4">
                                                <label for="praktikum_sks"
                                                    class="inline-block mb-2 ml-1 font-bold text-xs text-slate-700 dark:text-white/80">Praktikum</label>
                                                <input type="text" id="praktikum_sks" name="praktikum_sks"
                                                    class="focus:shadow-primary-outline dark:bg-slate-850 dark:text-white text-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none" />
                                            </div>
                                        </div>
                                        <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                            <div class="mb-4">
                                                <label for="praklap_sks"
                                                    class="inline-block mb-2 ml-1 font-bold text-xs text-slate-700 dark:text-white/80">Praktikum
                                                    Lapangan</label>
                                                <input type="text" id="praklap_sks" name="praklap_sks"
                                                    class="focus:shadow-primary-outline dark:bg-slate-850 dark:text-white text-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none" />
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="w-full max-w-full px-3 shrink-0">
                                    ...
                                    <div class="flex flex-wrap -mx-3">
                                        <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                            <div class="mb-4">
                                                <label for="bobot_nilai_minimal"
                                                    class="inline-block mb-2 ml-1 font-bold text-xs text-slate-700 dark:text-white/80">Bobot
                                                    Nilai Minimal untuk Lulus</label>
                                                <input type="text" id="bobot_nilai_minimal" name="bobot_nilai_minimal"
                                                    class="focus:shadow-primary-outline dark:bg-slate-850 dark:text-white text-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none" />
                                                <small class="text-gray-500">[Diisi dengan angka boleh desimal, dengan
                                                    nilai: 0.00 s/d 4.00]</small>
                                            </div>
                                        </div>
                                        <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                            <div class="mb-4">
                                                <label for="ipk_minimal"
                                                    class="inline-block mb-2 ml-1 font-bold text-xs text-slate-700 dark:text-white/80">Syarat
                                                    IPK Minimal</label>
                                                <input type="text" id="ipk_minimal" name="ipk_minimal"
                                                    class="focus:shadow-primary-outline dark:bg-slate-850 dark:text-white text-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none" />
                                                <small class="text-gray-500">[Diisi dengan angka boleh desimal, dengan
                                                    nilai: 0.00 s/d 4.00]</small>
                                            </div>
                                    ...
                                    <div class="w-full max-w-full px-3 shrink-0">
                                        <h6 class="leading-normal capitalize">Jumlah Minimal sks Matakuliah Telah Diambil
                                        </h6>
                                        <div class="flex flex-wrap -mx-3">
                                            <div class="w-full max-w-full px-3 shrink-0 md:w-4/12 md:flex-0">
                                                <div class="mb-4">
                                                    <label for="matkul_wajib"
                                                        class="inline-block mb-2 ml-1 font-bold text-xs text-slate-700 dark:text-white/80">Matakuliah
                                                        Wajib</label>
                                                    <div class="flex items-center">
                                                        <input type="text" id="matkul_wajib" name="matkul_wajib"
                                                            class="flex-grow focus:shadow-primary-outline dark:bg-slate-850 dark:text-white text-sm leading-5.6 ease block appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none" />
                                                        <p class="ml-2">SKS</p>
                                                    </div>
                                                    <small class="text-gray-500">[Diisi dengan angka [0-9], dengan nilai: 0
                                                        s/d 200]</small>
                                                </div>
                                            </div>
                                            <div class="w-full max-w-full px-3 shrink-0 md:w-4/12 md:flex-0">
                                                <div class="mb-4">
                                                    <label for="matkul_pilihan"
                                                        class="inline-block mb-2 ml-1 font-bold text-xs text-slate-700 dark:text-white/80">Matakuliah
                                                        Pilihan</label>
                                                    <div class="flex items-center">
                                                        <input type="text" id="matkul_pilihan" name="matkul_pilihan"
                                                            class="flex-grow focus:shadow-primary-outline dark:bg-slate-850 dark:text-white text-sm leading-5.6 ease block appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none" />
                                                        <p class="ml-2">SKS</p>
                                                    </div>
                                                    <small class="text-gray-500">[Diisi dengan angka [0-9], dengan nilai: 0
                                            ...
                                            <div class="w-full max-w-full px-3 shrink-0 md:w-4/12 md:flex-0">
                                                <div class="mb-4">
                                                    <label for="total_matkul"
                                                        class="inline-block mb-2 ml-1 font-bold text-xs text-slate-700 dark:text-white/80">Total
                                                        Matakuliah</label>
                                                    <div class="flex items-center">
                                                        <input type="text" id="total_matkul" name="total_matkul"
                                                            class="flex-grow focus:shadow-primary-outline dark:bg-slate-850 dark:text-white text-sm leading-5.6 ease block appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none" />
                                                        <p class="ml-2">SKS</p>
                                                    </div>
                                                    <small class="text-gray-500">[Diisi dengan angka [0-9], dengan nilai: 0
                                    ...
                                    <div class="w-full max-w-full px-3 shrink-0">
                                        <h6 class="leading-normal capitalize">Jumlah Minimal sks Matakuliah Telah Lulus
                                        </h6>
                                        <div class="flex flex-wrap -mx-3">
                                            <div class="w-full max-w-full px-3 shrink-0 md:w-4/12 md:flex-0">
                                                <div class="mb-4">
                                                    <label for="sks_matkul_wajib"
                                                        class="inline-block mb-2 ml-1 font-bold text-xs text-slate-700 dark:text-white/80">SKS
                                                        Matakuliah Wajib</label>
                                                    <div class="flex items-center">
                                                        <input type="text" id="sks_matkul_wajib"
                                                            name="sks_matkul_wajib"
                                                            class="flex-grow focus:shadow-primary-outline dark:bg-slate-850 dark:text-white text-sm leading-5.6 ease block appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none" />
                                                        <p class="ml-2">SKS</p>
                                                    </div>
                                                    <small class="text-gray-500">[Diisi dengan angka [0-9], dengan nilai: 0
                                            ...
                                            <div class="w-full max-w-full px-3 shrink-0 md:w-4/12 md:flex-0">
                                                <div class="mb-4">
                                                    <label for="sks_matkul_pilihan"
                                                        class="inline-block mb-2 ml-1 font-bold text-xs text-slate-700 dark:text-white/80">SKS
                                                        Matakuliah Pilihan</label>
                                                    <div class="flex items-center">
                                                        <input type="text" id="sks_matkul_pilihan"
                                                            name="sks_matkul_pilihan"
                                                            class="flex-grow focus:shadow-primary-outline dark:bg-slate-850 dark:text-white text-sm leading-5.6 ease block appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none" />
                                                        <p class="ml-2">SKS</p>
                                                    </div>
                                                    <small class="text-gray-500">[Diisi dengan angka [0-9], dengan nilai: 0
                                            ...
                                            <div class="w-full max-w-full px-3 shrink-0 md:w-4/12 md:flex-0">
                                                <div class="mb-4">
                                                    <label for="total_sks_matkul"
                                                        class="inline-block mb-2 ml-1 font-bold text-xs text-slate-700 dark:text-white/80">Total
                                                        SKS Matakuliah</label>
                                                    <div class="flex items-center">
                                                        <input type="text" id="total_sks_matkul"
                                                            name="total_sks_matkul"
                                                            class="flex-grow focus:shadow-primary-outline dark:bg-slate-850 dark:text-white text-sm leading-5.6 ease block appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none" />
                                                        <p class="ml-2">SKS</p>
                                                    </div>
                                                    <small class="text-gray-500">[Diisi dengan angka [0-9], dengan nilai: 0
    ...
    <script>
                        ...
                        if (response.data && Array.isArray(response.data.data)) {
                            ...
                            response.data.data.forEach(function(item) {
                                ...
                                table.row.add([
                                    nidndosen,
                                    namaLengkap,
                                    '<button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded" data-id="' +
                                    item.id + '">Pilih</button>'
                                ]).draw();
                            });
                        } else {
        ...
        function fetchMatkulData(matkulId) {
            ...
            document.getElementById('mkForm').addEventListener('submit', function(event) {
                ...
                console.log(document.getElementById('file_silabus').files[0]);
                ...
                const data = {
                    ...
                    nama_matkul_singkat_english: document.getElementById('nama_matkul_singkat_english')
                        .value,
                    ...
                    //getting file
                    file_silabus: document.getElementById('file_silabus').files[0],
                    _method: 'PUT',
                };
