...
<script>
  $(document).ready(function() {
    // Inisialisasi DataTable pada tabel dengan id 'semesterTable'
    const table = $('#semesterTable').DataTable({
      // Konfigurasi DataTables
      "searching": true // Ini akan mengaktifkan kotak pencarian
    });

    // Skrip Axios untuk mengambil data dari API
    ...
    axios.get(baseUrl)
      .then(response => {
        ...
        $('#semesterData').html(rows);
        // Re-inisialisasi DataTables setelah data dimuat
        table.clear().destroy();
